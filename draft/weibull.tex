...
\textcolor{blue}{
A common parametrization of temporal clustering is throught the two
point correlation function, $\xi(t)$, which describes the fractional 
excess over Poissonian at time lag $t$. The asymptotic forms of the
correlation function at short and long lags are:}
\begin{equation}
\xi(t)=\left\{ \begin{array}{ll} \propto t^{k-1} & t \lesssim t_0 \\
              \propto 1/t & t \gg t_0\end{array} \right.
\end{equation}

{\bf TODO: compute the actual prefactors}
